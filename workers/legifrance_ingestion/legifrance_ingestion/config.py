...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        enable_cnil=_as_bool(os.getenv("LEGI_ENABLE_CNIL"), True),
        enable_circulaires=_as_bool(os.getenv("LEGI_ENABLE_CIRCULAIRES"), True),
        ...
        dila_cnil_url=os.getenv("DILA_CNIL_URL", "https://echanges.dila.gouv.fr/OPENDATA/CNIL/"),
        dila_circulaires_url=os.getenv("DILA_CIRCULAIRES_URL", "https://echanges.dila.gouv.fr/OPENDATA/CIRCULAIRES/"),
    )
