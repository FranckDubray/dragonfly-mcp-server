...
Serveur MCP multi‑outils, rapide et extensible, propulsé par FastAPI. **43 tools** prêts à l'emploi, orchestrateur LLM avancé, panneau de contrôle web moderne.
...
Ci-dessous la liste complète, groupée par catégories. La version auto‑générée détaillée reste disponible dans src/tools/README.md.
...
- Tool Audit — Audit lecture-seule d’un tool MCP: périmètre strict au tool, contexte complet pour LLM, multi-profils (perf, quality, maintain, invariants)… · Tags: quality, performance, maintainability
