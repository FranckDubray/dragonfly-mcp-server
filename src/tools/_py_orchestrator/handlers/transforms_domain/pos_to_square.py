...
class PosToSquareHandler(AbstractHandler):
    """
    Project entity positions (x,z) to chessboard squares a1..h8 using origin/axis/case_size.
    Returns enriched items, a map piece_key->square, and a list of invalid (unsnapped) items.
    """
