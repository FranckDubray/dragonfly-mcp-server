# TRANSFORM_META_START
{
  ...
  "description": "Map a string template over a list of items and produce commands (strings)",
  "inputs": [
    "- items: list[object]",
    "- template: string",
    "- globals: object (optional)",
    "- color_map: object (optional)",
    "- default_block: string (optional)",
    "- round_coords: boolean (optional)"
  ],
  "outputs": [
